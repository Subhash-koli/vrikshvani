...
const guides: Record<string, {
  ...
  'monstera-deliciosa': {
    ...
    sections: [
      ...
      { heading: 'VPD Target (NIH-01)', content: 'Ideal VPD: 0.8–1.2 kPa. Below 0.6 kPa, risk of fungal issues on the broad leaves. Above 1.5 kPa, Monstera will show brown leaf tips as the first visible stress signal. NIH-01 will alert you before this becomes visible.' },
  ...
  'fiddle-leaf-fig': {
    ...
    sections: [
      ...
      { heading: 'VPD Target (NIH-01)', content: 'Ideal VPD: 0.8–1.5 kPa. This species has low tolerance for extremes. A VPD above 1.8 kPa will trigger brown patches on leaf edges within 48 hours. NIH-01 catches VPD excursions before leaf damage occurs.' },
