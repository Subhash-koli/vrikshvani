...
export const metadata: Metadata = {
  title: "Vriksh Vani (vrikshvani) — Let your plant speak. | Nature Intelligence",
  description: "Vriksh Vani (also vrikshvani / VrikshVani) is the pioneer of the Nature Intelligence category. Decoding leaf thermal biometrics, quad-gas telemetry, and plant voice AI synthesis at vrikshvani.com.",
  keywords: [
    "vrikshvani",
    "vriksh vani",
    "VrikshVani",
    ...
    "vrikshvani official website",
    "vriksh vani official site",
    "vrikshvani nature intelligence",
    "vriksh vani nature intelligence",
    "vrikshvani plant speaker",
    "vrikshvani subhash koli",
    "vriksh vani subhash koli",
    "Nature Intelligence Category",
  ...
  openGraph: {
    title: "Vriksh Vani (vrikshvani) — Let your plant speak.",
    description: "Nature Intelligence Category — Decodes plant health, stress, and emotions using non-invasive thermal biometrics and plant voice AI at vrikshvani.com.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Vriksh Vani (vrikshvani) — Let your plant speak. (Nature Intelligence Category)",
      },
    ],
    locale: "en_US",
    type: "website",
