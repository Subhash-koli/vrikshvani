...
const STAGES = [
  ...
  },
  {
    ...
    desc: 'Local SHT41 ambient sensors compute real-time Vapour Pressure Deficit (VPD) every 60 seconds.',
    color: 'text-[#8AD74C]',
  ...
  },
  {
    ...
    desc: 'On-device Cortex-M4 NPU classifies stomatal resistance, hydration, and thermal stress states.',
    color: 'text-[#8AD74C]',
    border: 'border-[#8AD74C]/30',
  },
  {
    ...
    name: 'UNDERSTANDING',
    icon: Sparkles,
    title: 'NTE™ Neural Voice Engine',
    desc: 'Translates biophysical states into natural human expressions across 8 native languages.',
    color: 'text-[#E8D07C]',
    border: 'border-[#E8D07C]/30',
  },
  {
    ...
    desc: 'Transforms plant care from guesswork into an emotional, intuitive bond between human and nature.',
    color: 'text-[#8AD74C]',
    border: 'border-[#8AD74C]/30',
  },
  {
    ...
    desc: 'Delivers warm, precise care recommendations before physical damage or wilting occurs.',
    color: 'text-[#8AD74C]',
    border: 'border-[#8AD74C]/30',
  },
];
    ...
    <section className="py-24 bg-[#070B08] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <Badge variant="lime">Core Innovation</Badge>
