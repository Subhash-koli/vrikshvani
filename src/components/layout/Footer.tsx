...
const footerColumns = [
  {
    ...
    links: [
      ...
      { label: 'Target Specifications', href: '/product/specifications' },
      { label: 'Ceramic Craftsmanship', href: '/product/craftsmanship' },
    ],
  },
  {
    heading: 'Science & Research',
    links: [
      { label: 'Research Hub & Hypotheses', href: '/nature-intelligence/research' },
      { label: 'Research Note #001', href: '/nature-intelligence/research/note-001' },
      { label: 'Evidence & Truth Registry', href: '/nature-intelligence/evidence' },
      { label: 'Open Telemetry (JSON)', href: '/api/v1/telemetry/sample' },
      { label: 'Species Library Concept', href: '/species' },
    ],
  },
  {
    heading: 'Community & Project',
    links: [
      { label: 'Join Research Waitlist', href: '/waitlist' },
      { label: 'Blog & Dispatches', href: '/blog' },
      { label: 'Brand Philosophy', href: '/about' },
      { label: 'VPD Guide', href: '/vpd-guide' },
    ],
  },
  {
    ...
    links: [
      ...
      { label: 'Environmental Targets', href: '/sustainability' },
