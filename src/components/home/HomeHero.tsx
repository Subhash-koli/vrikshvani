        ...
        <div className="w-full max-w-[1440px] mx-auto
          ...
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="sm:col-span-7 lg:col-span-6
              ...
              <div className="flex flex-row sm:flex-row items-center gap-2 sm:gap-3 pt-0.5 sm:pt-1">
                <Link href="/waitlist">
                  <Button
                    variant="primary"
                    size="lg"
                    className="rounded-full
                               ...
                               shadow-[0_0_20px_rgba(138,215,76,0.4)] hover:shadow-[0_0_36px_rgba(138,215,76,0.65)]
                               transition-all flex items-center gap-1.5 sm:gap-2 whitespace-nowrap"
                  >
                    <Leaf className="w-3 h-3 sm:w-4 sm:h-4 fill-current" />
                    Join Waitlist →
                  </Button>
                </Link>
                <Link href="/nature-intelligence">
                  <Button
                    ...
                    className="rounded-full
                               ...
                               bg-[#0F2B18]/80 hover:bg-[#0F2B18]
                               border-white/20 hover:border-[#8AD74C]/50
                               text-[#F7F6F2] backdrop-blur-xl
                               flex items-center gap-1.5 sm:gap-2 transition-all whitespace-nowrap"
                  >
                    <Play className="w-3 h-3 sm:w-4 sm:h-4 text-[#8AD74C] fill-[#8AD74C]" />
                    <span className="hidden sm:inline">Watch NTE™ Voice Demo</span>
